...
select monthly_salary as whose_salary
from salary s 
...
select employee_name, role_name, e.id 
from employees e 
join roles_employee re
on re.employee_id = e.id 
join roles r 
...
select sum(monthly_salary) as total_JS_salary
from salary s 
join employee_salary es 
on s.id = es.salary_id 
join roles_employee re 
...
select employee_name, role_name as job, monthly_salary 
from employees e 
join roles_employee re 
on e.id = re.employee_id 
join roles r 
